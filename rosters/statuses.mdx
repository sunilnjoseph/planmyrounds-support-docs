...
| **Failed** | Red | The engine could not produce a valid schedule. Open the roster to see the reason and [retry with relaxed constraints](/rosters/retrying-a-failed-roster). |
...
## Auto Duty planning cycle stages

Auto Duty follows its own stage sequence — Notify, Availability & Leave, Generate, Roster Review, Published (plus Failed and Cancelled). See [Running a planning cycle](/auto-duty-planning/running-a-planning-cycle#the-5-stages) for what each one means.
