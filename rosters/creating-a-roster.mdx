...
Adjust the inputs (add more doctors, loosen a rule, or shorten the period) and try again — or use [Retrying a failed roster](/rosters/retrying-a-failed-roster) to relax the constraints and add doctors from the failed roster's own page, without opening the wizard again.
