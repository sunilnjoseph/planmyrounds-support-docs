...
<Tip>
  Building the same roster every week or month? [Auto Duty Planning](/auto-duty-planning/overview) runs this lifecycle for you on a repeating schedule — notifying staff, collecting availability and leave, and generating the roster automatically.
</Tip>
...
For other ways to view what's scheduled, see the [Duty Calendar](/rosters/duty-calendar) (everyone's duties for the month, with a day drill-down) and the [Duty Dashboard](/rosters/duty-dashboard) (coverage and workload at a glance).
...
<CardGroup cols={2}>
  ...
  <Card title="View the Duty Calendar" icon="calendar-days" href="/rosters/duty-calendar">
    See every doctor's duties for the month in one place.
  </Card>

  <Card title="Automate it" icon="robot" href="/auto-duty-planning/overview">
    Let PlanMyRounds run this lifecycle for you on a repeating schedule.
  </Card>
</CardGroup>