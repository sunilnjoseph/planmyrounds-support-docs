...
description: "Understand the difference between members and doctors in PlanMyRounds, how the two link together, and how admin and member roles fit in."
icon: "circle-info"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Settings › Locations" icon="map-pin" href="/team/locations">
    Define the sites your organisation runs and assign doctors to them.
  </Card>
</CardGroup>
